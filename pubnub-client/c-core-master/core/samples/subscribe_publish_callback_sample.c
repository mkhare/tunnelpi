...
{
    printf("Srini sample_callback called with UserData %p\n", user_data);
...
{
    printf("Srini start_await called\n");
...
int main()
{
    ...
    */
    res = pubnub_publish(pbp_2, chan, "\"Hello duniya from subscribe-publish callback sample!\"");
    if (res != PNR_STARTED) {
