...
int main()
{
    ...
    pubnub_init(pbp, "pub-c-5615fe3c-6957-438a-a486-2a008462dbb4", "sub-c-cd0c981e-0708-11e6-a6c8-0619f8945a4f");
...
*/
    ...
    puts("Publishing2...");
    puts("-----------------------");
    res = pubnub_publish(pbp, chan, "\"Hello Srini!\"");
    if (res != PNR_STARTED) {
        printf("pubnub_publish() returned unexpected: %d\n", res);
        pubnub_free(pbp);
        return -1;
